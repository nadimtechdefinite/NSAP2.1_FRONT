...
const ABPTotalTranctionReport = ({ cardStyle }) => {
  const state = {
    series: [
      {
        name: 'ABP Transaction',
        data: [
          [16.4, 5.4],
          [21.7, 2],
          [25.4, 3],
          ...
          <Grid container alignItems="center" justifyContent="space-between">
            <Grid item>
              <Grid container direction="column" spacing={1}>
                <Grid item>
                  <Typography variant="h4">ABP/TOTAL TRANSACTION</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item>
...
export default ABPTotalTranctionReport;
