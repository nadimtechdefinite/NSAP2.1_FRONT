...
const AgeAbstractReport = ({ schemeCode }) => {
  const [tableData, setTableData] = useState([]);

  const classes = reportcss();

  AgeAbstractReport.propTypes = {
  ...
  const getAgeAbstractReportDetails = async () => {
    try {
      const response = await axiosInstance.get(`/report/findAllAgeReportDetails`);
              ...
              <div className="card">
                <div className="card-header text-center py-2">
                  <h1 className="mb-0 text-center">
                    <strong>Age Abstract Report</strong>
                  </h1>
                </div>
                      ...
                      >
                        <thead className="text-center table-active" style={{ borderBottom: '2px' }}>
                          <tr>
                            <th></th>
                            <th></th>
                            <th align="center" colSpan="6" className="scheme-ignoaps">
                              IGNOAPS
                            </th>
                            <th align="center" colSpan="6" className="scheme-igndps">
                              IGNDPS
                            </th>
                            <th align="center" colSpan="6" className="scheme-ignwps">
                              IGNWPS
                            </th>
                          ...
                          <tr>
                            ...
                            <th className="scheme-ignoaps">60&#8209;79</th>
                            <th className="scheme-ignoaps">80&#8209;100</th>
                            <th className="scheme-ignoaps">100 above</th>
                            ...
                            <th className="scheme-igndps">18&#8209;79</th>
                            <th className="scheme-igndps">80&#8209;100</th>
                            <th className="scheme-igndps">100 above</th>
                            ...
                            <th className="scheme-ignwps">40&#8209;79</th>
                            <th className="scheme-ignwps">80&#8209;100</th>
                            <th className="scheme-ignwps">100 above</th>
                            ...
                            <th className="scheme-nfbs">18&#8209;59</th>
                            <th className="scheme-nfbs">60&#8209;79</th>
                            <th className="scheme-nfbs">80&#8209;100</th>
                            <th className="scheme-nfbs">100 above</th>
                          </tr>
                        </thead>
                        <tbody className={classes.root}>
                          {tableData.map((row, index) => (
                            <tr key={index} className={row.stateName.trim().toUpperCase() === 'TOTAL' ? 'table-dark' : ''}>
                              ...
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-ignoaps'}>
                                {row.ignoapsAge60to79}
                              </td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-ignoaps'}>
                                {row.ignoapsAge80to100}
                              </td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-ignoaps'}>
                                {row.ignoapsAge100AndMore}
                              </td>
                              ...
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-igndps'}>
                                {row.igndpsAge80to100}
                              </td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-igndps'}>
                                {row.igndpsAge100AndMore}
                              </td>
                              ...
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-ignwps'}>
                                {row.ignwpsAge80to100}
                              </td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-ignwps'}>
                                {row.ignwpsAge100AndMore}
                              </td>
                              ...
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-nfbs'}>{row.nfbsAge18to59}</td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-nfbs'}>{row.nfbsAge60to79}</td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-nfbs'}>{row.nfbsAge80to100}</td>
                              <td className={row.stateName.trim().toUpperCase() === 'TOTAL' ? '' : 'scheme-nfbs'}>
                                {row.nfbsAge100AndMore}
                              </td>
                            </tr>
                          ))}
                        </tbody>
