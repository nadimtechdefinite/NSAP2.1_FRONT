...
const [formInput, setFormInput] = useReducer(
 ...
 // const [selectedStateId, setSelectedState] = useState('');
  ...
  const [subDistrictMunicipalAreaId, setSelectedSubDistrict] = useState('');
  ...
  const getGithubData = () => {
    ...
    Promise.all(endpoints.map((endpoint) => axios.get(endpoint))).then(([{data: allState},{data: allGender},{data: allCategory},{data: allArea}] )=> {
