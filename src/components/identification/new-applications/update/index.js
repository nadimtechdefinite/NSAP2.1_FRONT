...
import { Typography, Button, Stepper, Step, StepLabel } from '@mui/material'; //"@material-ui/core";
...
function getSteps() {
  return ['Beneficiary Personal Details', 'Beneficiary Bank Details', 'Beneficiary Aadhar Details', 'Beneficiary BPL Details', 'Preview'];
}
...
const LinaerStepper = () => {
  ...
  const handleNext = () => {
    ...
    if (activeStep === 4) console.log('hiiiiiii');
  };
        ...
        {activeStep === steps.length ? (
          ...
          <>
            ...
            {isStepOptional(activeStep) && (
              <Button className={classes.button} variant="contained" color="secondary" onClick={handleSkip}>
                skip
              </Button>
            )}

            <Button className={classes.button} variant="contained" color="secondary" onClick={handleNext}>
