...
const SocialCategoryReport = ({ cardStyle }) => {
  ...
  return (
    <MainCard style={cardStyle}>
      <Grid container spacing={2}>
          ...
          <Grid container alignItems="center" justifyContent="space-between">
            <Grid item>
              <Grid container direction="column" spacing={1}>
                <Grid item>
                  <Typography variant="h4">SOCIAL CATEGORY</Typography>
                </Grid>
              </Grid>
            </Grid>
            <Grid item>
        ...
        <Grid item xs={12}>
          <Chart options={state.options} series={state.series} type="pie" width={380} height={240} />
        </Grid>
        <Grid item xs={12}>
...
export default SocialCategoryReport;
